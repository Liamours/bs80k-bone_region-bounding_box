...
24 of 26 folders are solved and confirmed reliable. Shoulder is the one unresolved folder, roughly 13-30% of its predictions land somewhere anatomically wrong. One approach below, anchoring on vertebra, gives a real but partial improvement, nothing else fixes it. Detail and backing for every row is in the sections that follow.
